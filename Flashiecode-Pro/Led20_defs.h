...
#ifdef B1	// defined as binary constant? ATtinyCore should have used 0b1 instead of defining their own.
	#undef B1
#endif

#define V1  0b00000010
#define V2  0b00000100
#define V3  0b00001000
#define V4  0b00010000

#define B1  0b00100100
#define B2  0b00101000
#define B3  0b00110000
#define B4  0b00100001
...
#define Y1  0b01110000
#define Y2  0b01100001
#define Y3  0b01100010
#define Y4  0b01100100

#define R1  0b10000001
#define R2  0b10000010
#define R3  0b10000100
#define R4  0b10001000
...
const byte *Subroutines[32];

class NewSub {
public:
//constructor
  NewSub(const byte *Function, char Pos) { Subroutines[Pos] = Function;  };
};
...
#define Sub(NAME)                const int N##NAME=__COUNTER__;\
                                 extern byte PROGMEM const NAME[];\
                                 static NewSub S##NAME(NAME, N##NAME);\
                                 byte PROGMEM const NAME[] =
