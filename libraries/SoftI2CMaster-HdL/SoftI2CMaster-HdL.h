...
// stop condition.
// Return: true if the slave replies with an "acknowledge", false otherwise
bool i2c_rep_start(uint8_t addr) __attribute__ ((used));

// Issue a stop condition, freeing the bus.
void i2c_stop(void) asm("ass_i2c_stop") __attribute__ ((used));

// Write one byte to the slave chip that had been addressed
// by the previous start call. <value> is the byte to be sent.
// Return: true if the slave replies with an "acknowledge", false otherwise
bool i2c_write(uint8_t value) asm("ass_i2c_write") __attribute__ ((used));


// Read one byte. If <last> is true, we send a NAK after having received 
// the byte in order to terminate the read sequence. 
uint8_t i2c_read(bool last) __attribute__ ((used));
...
void i2c_delay_half(void) asm("ass_i2c_delay_half")  __attribute__ ((used));
void i2c_wait_scl_high(void) asm("ass_i2c_wait_scl_high")  __attribute__ ((used));

void  inline i2c_delay_half(void)
...
void inline i2c_wait_scl_high(void)
{
#if I2C_TIMEOUT <= 0
  __asm__ __volatile__ 
    ("_Li2c_wait_stretch: \n\t"
...
bool inline i2c_init(void)
{
  __asm__ __volatile__ 
    (" cbi      %[SDADDR],%[SDAPIN]     ;release SDA \n\t" 
     " cbi      %[SCLDDR],%[SCLPIN]     ;release SCL \n\t" 
     " sbi      %[SDAOUT],%[SDAPIN]     ;enable pullup on SDA \n\t" 
     " sbi      %[SCLOUT],%[SCLPIN]     ;enable pullupon SCL \n\t" 
...
bool  inline i2c_start(uint8_t addr)
{
  __asm__ __volatile__ 
    (
#if I2C_NOINTERRUPT
     ...
     " cbi      %[SDAOUT],%[SDAPIN]     ;force SDA low  \n\t" 
...
bool  inline i2c_rep_start(uint8_t addr)
{
  __asm__ __volatile__ 
    ...
    (
     ...
     " cli \n\t"
#endif
     " cbi	%[SCLOUT],%[SCLPIN]	;force SCL low \n\t" 
     " sbi	%[SCLDDR],%[SCLPIN]	;force SCL low \n\t" 
     " rcall 	ass_i2c_delay_half	;delay  T/2 \n\t" 
     " cbi	%[SDADDR],%[SDAPIN]	;release SDA \n\t" 
     " sbi	%[SDAOUT],%[SDAPIN]	;pullup SDA \n\t" 
     " rcall	ass_i2c_delay_half	;delay T/2 \n\t" 
     " cbi	%[SCLDDR],%[SCLPIN]	;release SCL \n\t" 
     " sbi	%[SCLOUT],%[SCLPIN]	;pullup SCL \n\t" 
     " rcall 	ass_i2c_delay_half	;delay  T/2 \n\t" 
     " sbis     %[SCLIN],%[SCLPIN]      ;check for clock stretching slave\n\t"
     " rcall    ass_i2c_wait_scl_high   ;wait until SCL=H\n\t" 
     " cbi 	%[SDAOUT],%[SDAPIN]	;force SDA low \n\t" 
...
void  inline i2c_start_wait(uint8_t addr)
{
 __asm__ __volatile__ 
   (
...
void  inline i2c_stop(void)
{
  __asm__ __volatile__ 
    (
     ...
     " cbi      %[SCLDDR],%[SCLPIN]     ;release SCL \n\t" 
     " sbi      %[SCLOUT],%[SCLPIN]     ;release SCL \n\t" 
     " rcall    ass_i2c_delay_half      ;T/2 delay \n\t"
     " sbis     %[SCLIN],%[SCLPIN]      ;check for clock stretching slave\n\t"
     " rcall    ass_i2c_wait_scl_high   ;wait until SCL=H\n\t" 
     " cbi      %[SDADDR],%[SDAPIN]     ;release SDA \n\t" 
     " sbi      %[SDAOUT],%[SDAPIN]     ;release SDA \n\t" 
...
bool inline i2c_write(uint8_t value)
{
  __asm__ __volatile__ 
    (
     " sec                              ;set carry flag \n\t"
     ...
     " sbi	%[SCLOUT],%[SCLPIN]	;release SCL           ;;+2 = 13C+X\n\t"
     ...
     "_Li2c_get_ack: \n\t"
     " cbi	%[SCLOUT],%[SCLPIN]	;force SCL low ;; +2 = 5C \n\t"
     ...
     " sbi	%[SCLOUT],%[SCLPIN]	;release SCL ;; +2 = 9C+X\n\t"
     "_Li2c_ack_wait: \n\t"
     ...
     "_Li2c_write_return: \n\t"
     " nop \n\t "
     " cbi	%[SCLOUT],%[SCLPIN]	;force SCL low so SCL=H is short\n\t"
...
uint8_t inline i2c_read(bool last)
{
  __asm__ __volatile__ 
    (
     ...
     " cbi	%[SDAOUT],%[SDAPIN]	;force SDA low         ;; 7C \n\t" 
     ...
     " sbi	%[SCLOUT],%[SCLPIN]	;release SCL           ;; 9C +X \n\t" 
     " cln                              ;clear N               ;; +1 = 10C\n\t"
     " nop \n\t "
     " nop \n\t "
     " sbis	%[SCLIN],%[SCLPIN]	;wait SCL high         ;; 12C + X\n\t" 
