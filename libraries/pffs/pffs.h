...
/
/   0: Byte-by-UCHAR access. Always compatible with all platforms.
/   1: Word access. Do not choose this unless following condition is met.
/
/  When the UCHAR order on the memory is big-endian or address miss-aligned
...
typedef struct _FATFS_ {
	UCHAR	fs_type;	/* FAT sub type */
	UCHAR	csize;		/* Number of sectors per cluster */
	UCHAR	flag;		/* File status flags */
	UCHAR	csect;		/* File sector address in the cluster */
	WORD	n_rootdir;	/* Number of root directory entries (0 on FAT32) */
	UCHAR*	buf;		/* Pointer to the disk access buffer */
...
/* FatFs refers the members in the FAT structures with UCHAR offset instead
...
/*--------------------------------*/
/* Multi-UCHAR word access macros  */
...
#else					/* Use UCHAR-by-UCHAR access to the FAT structure */
