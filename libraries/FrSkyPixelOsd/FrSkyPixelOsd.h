...
#if !defined(TEENSY_HW) && !defined(__AVR_ATmega328P__) && !defined(__AVR_ATmega2560__)
//  #error "Unsupported processor! Only Teesny LC/3.x/4.x, ATmega2560 and ATmega328P based boards are supported.";
#endif

#if defined(OSD_USE_SOFTWARE_SERIAL) && !defined(TEENSY_HW) && !defined(__AVR_ATmega2560__)
